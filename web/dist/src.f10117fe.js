...
/** @class */
function () {
  function Model(events, attributes, sync) {
    this.events = events;
...
function () {
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (attrs) {
        var user = _this.deserealize(attrs);
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Eventing_1.Eventing(), new Attributes_1.Attributes(attrs), new ApiSync_1.ApiSync(rootUrl));
  };
...
userForm.render();
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"C:/Users/guilh/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/guilh/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","src/index.ts"], null)
